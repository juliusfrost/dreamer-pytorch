# import torch
#
# from dreamer.agents.atari_dreamer_agent import DiscreteDreamerAgent
...
#
#     # No noise
#     agent = DiscreteDreamerAgent(train_noise=0, eval_noise=0.5, expl_type="epsilon_greedy", expl_min=0)
...
#
#     # Decaying noise
#     agent = DiscreteDreamerAgent(train_noise=1, eval_noise=0.5, expl_type="epsilon_greedy", expl_decay=5, expl_min=0)
#     agent.initialize(AtariEnv().spaces)
#     agent.sample_mode(0)
#     action = torch.tensor([-1])  # Not a valid action, but it will let us check the action has been changed.
#     new_action = agent.exploration(action)
...
#     assert new_action.item() == -1
#
#     agent = DiscreteDreamerAgent(train_noise=1, eval_noise=0.5, expl_type="epsilon_greedy", expl_decay=5, expl_min=1)
#     agent.initialize(AtariEnv().spaces)
#     agent.sample_mode(10)
...
#
#     # Different modes
#     agent = DiscreteDreamerAgent(train_noise=1, eval_noise=0, expl_type="epsilon_greedy", expl_min=0)
#     agent.initialize(AtariEnv().spaces)
#     agent.train_mode(0)
#     new_action = agent.exploration(action)
#     assert new_action.item() > -1
...
#     assert new_action.item() == -1
#
#     agent = DiscreteDreamerAgent(train_noise=0, eval_noise=1, expl_type="epsilon_greedy", expl_min=0)
#     agent.initialize(AtariEnv().spaces)
#     agent.train_mode(0)
#     new_action = agent.exploration(action)
#     assert new_action.item() == -1
...
#     agent = DiscreteDreamerAgent(train_noise=0.5, eval_noise=0, expl_type="completely_random", expl_min=0)
#     agent.initialize(AtariEnv().spaces)
#     agent.train_mode(0)
...
#
#     agent = DiscreteDreamerAgent(train_noise=0, eval_noise=0, expl_type="completely_random", expl_min=0)
#     agent.initialize(AtariEnv().spaces)
#     agent.train_mode(0)
#     new_action = agent.exploration(action)
...
#     agent = DiscreteDreamerAgent(train_noise=0, expl_type="additive_gaussian", expl_min=0)
#     agent.initialize(AtariEnv().spaces)
#     agent.train_mode(0)
...
#     assert torch.all(torch.eq(new_action, action))
#
#     agent = DiscreteDreamerAgent(train_noise=1, expl_type="additive_gaussian", expl_min=0)
#     agent.initialize(AtariEnv().spaces)
#     agent.train_mode(0)
#     action = torch.randn(100)
#     new_action = agent.exploration(action)
